...
public class MonkeyAdventure {
    ...
    public static boolean blidemode = false;
    public static boolean nightmode = false;
    public static int deathreason = 0;
    public static SoundPlayer monstersound = new SoundPlayer("monster.wav");
    public static SoundPlayer coin = new SoundPlayer("coin.wav");
    // 1= monster, 2= trial, fail, 3 = lava

    public static void main(String[] args) {
        playSound("backround.wav");
        showMainMenu();
    ...
    public static void showMainMenu() {
        ...
        JCheckBox blind = new JCheckBox("Blide mode");
        blind.addActionListener(e -> blidemode = !blidemode);
        JCheckBox night = new JCheckBox("Night mode");
        night.addActionListener(e -> nightmode = !nightmode);
        buttonPanel.add(night);
        buttonPanel.add(startGame);
        buttonPanel.add(quit);
        buttonPanel.add(blind);
            ...
            for (int y = 0; y < maze.length; y++) {
                ...
                if (nightmode){
                    if (x <= playerX + 1 && y <= playerY + 1 && x >= playerX - 1 && y >= playerY - 1) {
                        if (tile == '#')
                            g.drawImage(new ImageIcon("wall.png").getImage(), x * cellSize, y * cellSize, cellSize,
                                    cellSize, this);

                        else if (tile == 'L')
                            g.drawImage(new ImageIcon("lava.png").getImage(), x * cellSize, y * cellSize, cellSize,
                                    cellSize, this);
                        else if (tile == 'B')
                            g.drawImage(new ImageIcon("banana.png").getImage(), x * cellSize, y * cellSize, cellSize,
                                    cellSize, this);
                        else if (tile == 'O')
                            g.drawImage(new ImageIcon("hole.png").getImage(), x * cellSize, y * cellSize, cellSize,
                                    cellSize, this);
                        else if (tile == 'W')
                            g.drawImage(new ImageIcon("door.png").getImage(), x * cellSize, y * cellSize, cellSize,
                                    cellSize, this);
                            ...
                            if (!completedTrials.contains(tile))
                                ...
                                g.drawImage(new ImageIcon("floor.png").getImage(), x * cellSize, y * cellSize, cellSize,
                                        cellSize, this);
                        } else
                            g.drawImage(new ImageIcon("floor.png").getImage(), x * cellSize, y * cellSize, cellSize,
                                    cellSize, this);
                    } else {
                        g.drawImage(new ImageIcon("black.png").getImage(), x * cellSize, y * cellSize, cellSize,
                                cellSize, this);
                    }
                }else{
                    if (tile == '#')
    ...
    if (!completedTrials.contains(tile))
        ...
        g.drawImage(new ImageIcon("floor.png").getImage(), x * cellSize, y * cellSize, cellSize,
            ...
            g.drawImage(new ImageIcon("monkey.png").getImage(), playerX * cellSize + 5, playerY * cellSize + 5, 30, 30,
                    this);
                    if (nightmode){
        if (monsterX <= playerX + 2 && monsterY <= playerY + 2 && monsterX >= playerX - 2 && monsterY >= playerY - 2){
            g.drawImage(new ImageIcon("monster.png").getImage(), monsterX * cellSize + 5, monsterY * cellSize + 5, 30,
                    30, this);
        }else if ((monsterX <= playerX + 3 && monsterY <= playerY + 3 && monsterX >= playerX - 3 && monsterY >= playerY - 3)){
            monstersound.play();
        }
        else{ g.drawImage(new ImageIcon("black.png").getImage(), monsterX * cellSize + 5, monsterY * cellSize + 5, 30,
        30, this);}
        ...
        g.drawImage(new ImageIcon("monster.png").getImage(), monsterX * cellSize + 5, monsterY * cellSize + 5, 30,
        30, this);
         if ((monsterX <= playerX + 3 && monsterY <= playerY + 3 && monsterX >= playerX - 3 && monsterY >= playerY - 3)){
        monstersound.play();
    }
        }
    }
        ...
        private void moveMonster() {
            if (playerX > monsterX && maze[monsterY][monsterX + 1] != '#' && playerX > monsterX
                    && maze[monsterY][monsterX + 1] != 'O')
                monsterX++;
            else if (playerX < monsterX && maze[monsterY][monsterX - 1] != '#' && playerX < monsterX
                    && maze[monsterY][monsterX - 1] != 'O')
                monsterX--;
            else if (playerY > monsterY && maze[monsterY + 1][monsterX] != '#' && playerY > monsterY
                    && maze[monsterY + 1][monsterX] != 'O')
                monsterY++;
            else if (playerY < monsterY && maze[monsterY - 1][monsterX] != '#' && playerY < monsterY
                    && maze[monsterY - 1][monsterX] != 'O')
                monsterY--;
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (blidemode) { // Play sound for all adjacent tiles
            ...
            if (newX >= 0 && newY >= 0 && newX < maze[0].length && newY < maze.length && maze[newY][newX] != '#') {
                ...
                if ("1234".indexOf(current) >= 0 && !completedTrials.contains(current)) {
                    ...
                    if (completedTrials.containsAll(requiredTrials)) {
                        ...
                        if (current == '1')
                            playTrial("mika1.png", "Follow the sound pattern", "Walk straight across quickly",
                                    "You make it safely.", "Trap collapses.");
                        if (current == '2')
                            playTrial("mika2.png", "Feel air flow", "Watch shadows", "You find a hidden passage.",
                                    "You get zapped.");
                        if (current == '3')
                            playTrial("mika3.png", "Tiptoe edge", "Rush middle", "Silent footwork succeeds.",
                                    "Stone falls on you!");
                        if (current == '4')
                            playTrial("mika4.png", "Whistle rhythm", "Clap twice", "Final door opens!",
                                    "Posion blow dart shoots out of the wall!");
                    }
                } else if (current == 'L') {
                    gameTimer.stop();
                    deathreason = 3;
    ...
    public static void playTrial(String imageName, String optionAText, String optionBText, String resultA,
            String resultB) {
    ...
    public static void showGameOver() {
        ...
        switch (deathreason) {
            case 1:
                JOptionPane.showMessageDialog(deadFrame, "You have been killed by the monster.");
                break;
            case 2:
                JOptionPane.showMessageDialog(deadFrame, "You have failed the trial");
                break;
            case 3:
                JOptionPane.showMessageDialog(deadFrame, "You have burned to death on lava");
                break;
            default:
                JOptionPane.showMessageDialog(deadFrame, "how the fuck did you die");
                break;
        }
    }
...
// public class MonkeyAdventure {
// public static JFrame mazeFrame = new JFrame("Maze");
// public static JFrame frame = new JFrame("Monkey Island: The Forbidden
// Temple");
// public static Set<Character> completedTrials = new HashSet<>();
// public static int bananaCount = 0;
// public static int moveCount = 0;
...
// }
//
// g.drawImage(new ImageIcon("monkey.png").getImage(), playerX * cellWidth,
// playerY * cellHeight, cellWidth, cellHeight, this);
// g.drawImage(new ImageIcon("monster.png").getImage(), monsterX * cellWidth,
// monsterY * cellHeight, cellWidth, cellHeight, this);
//
// g.setColor(Color.YELLOW);
...
// else if (playerX < monsterX && maze[monsterY][monsterX - 1] != '#')
// monsterX--;
// else if (playerY > monsterY && maze[monsterY + 1][monsterX] != '#')
// monsterY++;
// else if (playerY < monsterY && maze[monsterY - 1][monsterX] != '#')
// monsterY--;
// }
...
// moveMonster();
//
// if (playerX == monsterX && playerY == monsterY || maze[playerY][playerX] ==
// 'L') {
// gameTimer.stop();
// showGameOver();
// SwingUtilities.getWindowAncestor(this).dispose();
...
// bananaCount++;
// maze[playerY][playerX] = ' ';
// } else if ("1234".indexOf(current) >= 0 &&
// !completedTrials.contains(current)) {
// completedTrials.add(current);
// maze[playerY][playerX] = ' ';
// Set<Character> requiredTrials = new HashSet<>(Arrays.asList('1', '2', '3',
// '4'));
// if (completedTrials.containsAll(requiredTrials)) {
// JOptionPane.showMessageDialog(this, "All trials complete! Proceed to the
// final door.");
// gameTimer.stop();
// showMaze(true);
// SwingUtilities.getWindowAncestor(this).dispose();
// } else {
// if (current == '1') playTrial("mika1.png", "Follow the sound pattern", "Walk
// straight across quickly", "You make it safely.", "Trap collapse");
// if (current == '2') playTrial("mika2.png", "Feel air flow", "Watch shadows",
// "You find a hidden passage.", "You get zapped.");
// if (current == '3') playTrial("mika3.png", "Tiptoe edge", "Rush middle",
// "Silent footwork succeeds.", "Stone falls on you!");
// if (current == '4') playTrial("mika4.png", "Whistle rhythm", "Clap twice",
// "Final door opens!", "Posion blow dart shoots out of the wall!");
// }
//
//
//
...
// }
//
// public static void playTrial(String imageName, String optionAText, String
// optionBText, String resultA, String resultB) {
// JFrame trialFrame = new JFrame("Trial");
// trialFrame.setSize(800, 600);
// trialFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
//
